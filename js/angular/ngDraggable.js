        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var moveElement = function (x, y) {
                    //his if added because in that app we use ui-sortable which has his own matrix3d and it work 2 time and object change his position
                    // && !(element[0].localName == 'li') added part
                    if (allowTransform && !(element[0].localName == 'li')) {
                        element.css({
