...
.factory('Fabric', [
	...
	function (FabricWindow, $timeout, $window, FabricCanvas, FabricDirtyStatus) {
        ...
        return function (options) {
            ...
            // Rectangle
            // ==============================================================
            self.addRectangle = function (str) {
                var object = new FabricWindow.Rect(self.rectDefaults);
                object.id = self.createId();
            ...
            self.getRectangle = function () {
                return getActiveProp('rectangle');
            };

            self.setRectangle = function (value) {
                setActiveProp('rectangle', value);
            };
            ...
            self.init = function () {
                ...
                JSONObject.width = JSONObject.width || 1024;
                self.canvasOriginalWidth = JSONObject.width;

                JSONObject.height = JSONObject.height || 768;
